...
# Read csv file
df_2019 <- read.csv('../../data/02-visualization-data/df_2019.csv')

df_2019 <- t(df_2019)

knitr::kable(head(df_2019, 5))
```
...
# Read csv file
df_2022 <- read.csv('../../data/02-visualization-data/df_2022.csv')

df_2022 <- t(df_2022)

knitr::kable(head(df_2022, 5))
```
