...
#| message: false
#| code-fold: true
#| code-summary: "Global Oil Production - Data"
#| results: 'hide'
#| warning: false
...
#| message: false
#| code-fold: true
#| code-summary: "U.S. Inflation Rate - Data"
#| warning: false
...
#| message: false
#| code-fold: true
#| code-summary: "U.S. Interest Rate - Data"
#| results: 'hide'
#| warning: false
...
#| message: false
#| code-fold: true
#| code-summary: "Crude Oil Price - Data"
#| results: 'hide'
#| warning: false
...
#### [Energy Sector](https://finance.yahoo.com/quote/IYE?p=IYE&.tsrc=fin-srch), [Transportation](https://finance.yahoo.com/quote/IYT?p=IYT&.tsrc=fin-srch) and [Staples Indexes](https://finance.yahoo.com/quote/IYK?p=IYK&.tsrc=fin-srch)
...
#| message: false
#| code-fold: true
#| code-summary: "Energy Sector, Transportation and Saples Indexes - Data"
#| warning: false
...
fig <- plot_ly(stock, type = 'scatter', mode = 'lines')%>%
  ...
  layout(title = 'Energy Sector, Transportation and Staples Indexes', legend=list(title=list(text='Indexes')),
         xaxis = list(rangeslider = list(visible = T)), width = 800, height = 400)
options(warn = -1)
fig <- fig %>%
  layout(
