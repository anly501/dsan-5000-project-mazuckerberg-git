...
The first step to begin the analysis was to import the dataset containing the time series data for the daily U.S. Oil Production by Year. 
...
# ACF Plot
acf_oil_production <- ggAcf(diff_oil_production, main="ACF Plot for Oil Production")

# PACF Plot
pacf_oil_production <- ggPacf(diff_oil_production, main="PACF Plot for Oil Production")
...
# Path to save plot
file_path <- "../images/6_oil_production_year.png"
